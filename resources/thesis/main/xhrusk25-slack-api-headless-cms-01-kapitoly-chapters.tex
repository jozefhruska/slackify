...
V dnešnej dobe štandardný typ databázy pre ukladanie a prístup k dátam vo vzájomných väzbách. Dáta sú rozdelené do tabuliek, kde každý riadok reprezentuje jednu entitu. Entita je vždy identifikovateľná svojim primárnym kľúčom, ktorý musí byť v danej tabulke unikátny. Každý stĺpec tabulky má vopred definovaný dátový typ a nesie hodnoty pre každý element v tabuľke. \\
...
\noindent Niektoré bloky podporujú formátovanie pomocou modifikovanej verzie jazyka \emph{markdown}.