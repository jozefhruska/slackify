...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Rád by som poďakoval Ing. Vladimírovi Bartíkovi, Ph.D. za odborné vedenia a čas venovaný mojej bakalárskej práci. Ďaľej by som rád poďakoval Bc. Jánovi Vorčákovi za inšpiráciu vedúcu k téme tejto práce a za jeho cenné rady a konzultácie.},
...
\begin{document}
  ...
  % ----------------------------------------------
  \ifenglish
    \input{xhrusk25-slack-api-headless-cms-01-kapitoly-chapters-en}
  \else
    \input{xhrusk25-slack-api-headless-cms-01-kapitoly-chapters}
  \fi
...
\fi
  ...
  % Přílohy / Appendices
  \ifenglish
    \input{xhrusk25-slack-api-headless-cms-30-prilohy-appendices-en}
  \else
    \input{xhrusk25-slack-api-headless-cms-30-prilohy-appendices}
  \fi
