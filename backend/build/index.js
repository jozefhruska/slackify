...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "ead5e95519772320d982";
...
/* harmony import */ var opn__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("opn");
...
/* harmony import */ var _server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/server.ts");
...
try {
    ...
    Object(_server__WEBPACK_IMPORTED_MODULE_1__["default"])(PORT_1).then(function (serverInstance) {
        if ( false || firstStartInDevMode_1) {
            console.log("GraphQL Server is now running on http://localhost:" + PORT_1);
            if (firstStartInDevMode_1) {
                opn__WEBPACK_IMPORTED_MODULE_0___default()("http://localhost:" + PORT_1 + "/api/swagger");
            }
        }
...
/******/ });
//# sourceMappingURL=index.e7c6aa15d245e7d2b48a.js.map